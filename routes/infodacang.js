...
router.post("/insert", jsonParser, function (req, res, next) {
  ...
  query(
    "INSERT INTO information_dengji_dacang(`name`,`phone`,`cardnumber`,`address`,`temperature`,`createtime`) VALUES ('" +
      username +
      "'" +
      ",'" +
      phone +
...
router.get("/get", function (req, res, next) {
  ...
  var str = "SELECT * from information_dengji_dacang where 1=1";
...
const write = function (datas,callback) {
  ...
  var path = `./tempdacang/file${getDate()}.xlsx`;
  // 定义表格存放路径
