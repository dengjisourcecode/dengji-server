...
router.post("/insert", jsonParser, function (req, res, next) {
  ...
  query(
    "INSERT INTO information_dengji_jiangpuyuan(`name`,`phone`,`cardnumber`,`address`,`temperature`,`createtime`) VALUES ('" +
      username +
      "'" +
      ",'" +
      phone +
...
router.get("/get", function (req, res, next) {
  ...
  var str = "SELECT * from information_dengji_jiangpuyuan where 1=1";
...
const write = function (datas,callback) {
  ...
  var path = `./tempjiangpuyuan/file${getDate()}.xlsx`;
  // 定义表格存放路径
